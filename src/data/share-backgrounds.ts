...
export const shareBackgrounds: ShareBackground[] = [
  ...
  },
  {
    ...
    palette: { deep: '#1a3540', mid: '#3a6675', accent: '#e2c9a0', ink: '#f5f2eb', muted: '#c5d5db' },
  },
  {
    unsplashId: 'photo-1439066615861-d1af74d74000',
    palette: { deep: '#1c2f45', mid: '#3f5f82', accent: '#d5bc8e', ink: '#f3f0e9', muted: '#c4d0de' },
  },
  {
    unsplashId: 'photo-1501785888041-af3ef285b470',
    palette: { deep: '#1e2a24', mid: '#3f5648', accent: '#d0b88a', ink: '#f4f1ea', muted: '#c8d1cb' },
  },
  {
    unsplashId: 'photo-1470770841072-f978cf4d019e',
    palette: { deep: '#243040', mid: '#4a5f78', accent: '#e0c49a', ink: '#f6f2ea', muted: '#cad3de' },
  },
  {
    unsplashId: 'photo-1441974231531-c6227db76b6e',
    palette: { deep: '#1f3528', mid: '#456b52', accent: '#cbb887', ink: '#f3f0e8', muted: '#c5d0c8' },
  },
  {
    unsplashId: 'photo-1502082553048-f009c37129b9',
    palette: { deep: '#2c2418', mid: '#5c4a32', accent: '#e8c98e', ink: '#f8f3ea', muted: '#ddd0c0' },
  },
  {
    unsplashId: 'photo-1518495973542-4542c06a5843',
    palette: { deep: '#2a1c28', mid: '#5a3d52', accent: '#e2b894', ink: '#f7f1ea', muted: '#d6c8d0' },
  },
  {
    unsplashId: 'photo-1465146633011-14f8e0781093',
    palette: { deep: '#2e1f18', mid: '#6a4630', accent: '#efc99a', ink: '#f8f3ea', muted: '#e0d0c2' },
  },
  {
    unsplashId: 'photo-1506744038136-46273834b3fb',
    palette: { deep: '#1a3038', mid: '#3d6470', accent: '#d8bf90', ink: '#f4f1ea', muted: '#c5d4d8' },
  },
  {
    unsplashId: 'photo-1433086966358-54859d0ed716',
    palette: { deep: '#1c2830', mid: '#3a5560', accent: '#c9b48a', ink: '#f2efe8', muted: '#c2ced4' },
  },
  {
    unsplashId: 'photo-1470252649378-9c29740c9fa8',
    palette: { deep: '#3a2818', mid: '#7a5530', accent: '#f0c98a', ink: '#f8f3e9', muted: '#e2d0bc' },
  },
  {
    unsplashId: 'photo-1506260408121-e353d10b87c7',
    palette: { deep: '#1e2838', mid: '#425870', accent: '#d4b892', ink: '#f4f1ea', muted: '#c6d0dc' },
  },
  {
    unsplashId: 'photo-1518837695005-2083093ee35b',
    palette: { deep: '#142e3c', mid: '#2f6478', accent: '#e8c89a', ink: '#f6f3ec', muted: '#c4d8e0' },
  },
  {
    unsplashId: 'photo-1482192505345-5655af888cc4',
    palette: { deep: '#222830', mid: '#4a5560', accent: '#d0b890', ink: '#f3f0e9', muted: '#c8ced4' },
  },
  {
    unsplashId: 'photo-1494500764479-0c8f2919a3d8',
    palette: { deep: '#1a2840', mid: '#3a5478', accent: '#dcc08c', ink: '#f4f1ea', muted: '#c5d0e0' },
  },
  {
    unsplashId: 'photo-1511593358241-7eea1f3c84f5',
    palette: { deep: '#183038', mid: '#3a6870', accent: '#e0c8a0', ink: '#f5f2eb', muted: '#c6d8dc' },
  },
  {
    unsplashId: 'photo-1454496522488-7a8e488e8606',
    palette: { deep: '#2a2438', mid: '#524a68', accent: '#e2b8a0', ink: '#f6f1ea', muted: '#d2ccd8' },
  },
  {
    unsplashId: 'photo-1483728642387-6c3bddfbaadc',
    palette: { deep: '#1c2430', mid: '#3e4e62', accent: '#d6bc8e', ink: '#f3f0e9', muted: '#c6d0da' },
  },
];
